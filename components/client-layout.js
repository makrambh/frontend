...
import { FileText, MessageSquare, Settings, LogOut, Menu, X, Home, PlusCircle } from "lucide-react"
      ...
      >
        <div className="flex h-full flex-col">
          <div className="flex h-16 items-center justify-center border-b">
            <h2 className="text-xl font-bold text-blue-700">Espace Client</h2>
          </div>
